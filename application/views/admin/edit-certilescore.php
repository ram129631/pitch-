			...
			<!-- Body Content goes here -->
				<section class="adminDashboardView">
					<div class="UserListView container">
                                            <?php
                                            $query = $this->db->query("select * from pitch_certilescore where id='$id'");
                                            
                                            $row = $query->row();
                                            ?>
                                            
                                            <form action="<?php echo site_url('edit-update-certile-score'); ?>">
                                                <div class="form-group">
                                                  <label for="exampleInputEmail1">Ages</label>
                                                  <input type="text" name="ages" class="form-control" id="exampleInputEmail1" value="<?php echo $row->ages; ?>">
                                                </div>
                                                <div class="form-group">
                                                  <label for="exampleInputPassword1">Gender</label>
                                                  <input type="text" name="gender" class="form-control" id="exampleInputEmail1" value="<?php echo $row->gender; ?>">
                                                </div>
                                                <div class="form-group">
                                                  <label for="exampleInputPassword1">Score</label>
                                                  <input type="text" name="score" value="<?php echo $row->score; ?>" class="form-control" id="exampleInputPassword1" placeholder="Password">
                                                </div>
                                                <div class="form-group">
                                                  <label for="exampleInputPassword1">Certile</label>
                                                  <input type="text" name="certile" value="<?php echo $row->certile; ?>" class="form-control" id="exampleInputPassword1" placeholder="Password">
                                                </div> 
