<?=$Header;?>
	...
	<!-- Registration Block goes here -->
         <form class="form-horizontal col-lg-4 col-md-5 col-sm-6 col-xs-6" role="form" id="ToneRegisterForm" action="<?php echo site_url('home/register'); ?>" method="POST" autocomplete="false">
         		<?php
		...
		<script src="<?php echo site_url('resources/js/formValidator.js'); ?>"></script>
