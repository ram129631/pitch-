			$('document').ready(function(){
				   // More Info Audio
					...
					ctrlaudioNewExampleInfo.InnerHtml = innerHTML;
					...
					hdImgNames = "img/moreinfo/1.jpg" + "," + "img/moreinfo/2.jpg" + "," + "img/moreinfo/3.jpg" + "," + "img/moreinfo/4.jpg" + "," + "img/moreinfo/5.jpg" + "," + "img/moreinfo/6.jpg" + "," + "img/moreinfo/start7.jpg";
					$(function () {
					 //Find the audio control on the page
					   var audio = document.getElementById('ctrlaudioNewExampleInfo');
